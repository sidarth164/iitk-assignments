...
int pageReplacementAlgo;    // replacement Algorithm for demand paging
...
//===================================================================================
    physPageVPN = new int[NumPhysPages];
    physPageFIFO = new int[NumPhysPages];
    physPageLRU = new int[NumPhysPages] ;
    LRULock = new bool[NumPhysPages];
    physPagePID = new int[NumPhysPages];
    sharedCount = new int[NumPhysPages];
    physPageIsFree = new bool[NumPhysPages];
    for(i=0;i<NumPhysPages;i++){
        sharedCount[i]=0;
        physPageIsFree[i]=true;
        physPageVPN[i]=-1;
        physPageFIFO[i]=-1;
        physPageLRU[i]=-1;
        LRULock[i]=FALSE;
